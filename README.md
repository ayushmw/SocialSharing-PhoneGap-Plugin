...
[npm-url]:https://npmjs.org/package/@ayushmw/cordova-plugin-x-socialsharing
...
```
$ phonegap local plugin add https://github.com/ayushmw/SocialSharing-PhoneGap-Plugin.git
```

or with Cordova CLI, from npm:
```
$ cordova plugin add @ayushmw/cordova-plugin-x-socialsharing
$ cordova prepare
```
...
```xml
<gap:plugin name="@ayushmw/cordova-plugin-x-socialsharing" source="npm" />
```
...
```
$ cordova plugin add @ayushmw/cordova-plugin-x-socialsharing --variable PHOTO_LIBRARY_USAGE_DESCRIPTION="This app uses your photo library" --variable PHOTO_LIBRARY_ADD_USAGE_DESCRIPTION="This app saves images your photo library"
```
